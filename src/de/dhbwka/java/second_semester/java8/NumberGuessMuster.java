...
public class NumberGuessMuster extends JFrame {
	...
	public void addEventHandling() {
		this.btnNew.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				NumberGuessMuster.this.createRandomNumber();
			}
		});
		...
		ActionListener okListener = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent event) {
				NumberGuessMuster.this.okActionListener(event);
			}
		};
		...
		this.btnStat.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent event) {
				NumberGuessMuster.this.showBestPlayer();
			}
		});
	}
	...
	private void showBestPlayer() {
		...
		String name = "";
		try (BufferedReader in = new BufferedReader(new FileReader(this.statFileName))) {
			String line;
			do {
				try {
					line = in.readLine();
			...
			this.txtOutput.setText("Best Player: " + name + ", " + minAttempts + " attempts");
		} catch (Exception ex) {
		}
	}
